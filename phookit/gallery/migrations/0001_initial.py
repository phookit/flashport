...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gallery_tag', (
            ...
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('main_tag', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        ...
        db.create_table(u'gallery_image', (
            ...
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['gallery.Tag'])),
        ...
        # Adding M2M table for field other_tags on 'Image'
        m2m_table_name = db.shorten_name(u'gallery_image_other_tags')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field other_tags on 'Image'
        db.delete_table(db.shorten_name(u'gallery_image_other_tags'))
    ...
    models = {
        ...
        u'gallery.image': {
            'Meta': {'ordering': "('-publish_date',)", 'object_name': 'Image'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'other_tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'other_tags'", 'blank': 'True', 'to': u"orm['gallery.Tag']"}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': u"orm['gallery.Tag']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'images'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'gallery.tag': {
            'Meta': {'ordering': "('priority',)", 'object_name': 'Tag'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_tag': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
